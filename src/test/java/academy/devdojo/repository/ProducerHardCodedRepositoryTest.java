...
class ProducerHardCodedRepositoryTest {
    ...
    @Test
    @DisplayName("findAll returns an object with given id")
    @Order(2)
    ...
    @Test
    @DisplayName("findByName returns all producer when name is null")
    @Order(3)
    ...
    @Test
    @DisplayName("findByName() return list with filtered producers name is not null")
    @Order(4)
    ...
    void update_UpdateProducer_WhenSuccessful() {
        ...
        this.producers
                ...
                .findFirst()
                .ifPresent(producer -> Assertions.assertThat(producer.getName())
